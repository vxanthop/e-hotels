...
(539079664, 3, DATE('2014-05-11'), DATE('2015-07-30'), 'gardener'),
(539079664, 9, DATE('2015-07-31'), DATE('2019-04-03'), 'manager'),
...
(991468022, 11, DATE('2007-04-22'), DATE('2010-12-14'), 'receptionist'),
